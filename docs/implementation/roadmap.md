...
- **The boundaries hold throughout.** Nothing outside L1 is
  ...
  and in the realization's admission economy; the graph carries pointers,
...
1. Push notifications — 3.1's second channel.
2. Change histories — the staged workstream.
3. Chats — slice 5's chat half. Not make-or-break for the first
...
- The staged-applicant flow end to end: invite link → registration
  (account + session) → logged-in key ceremony (actor key +
...
- Built against [notifications.md](notifications.md): the nine
