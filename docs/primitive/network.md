...
|---|---|---|
| **The Genesis Moderator** | the operator's own account — the first member; an ordinary Actor + Profile with a self-custodied address, undemotably `moderator` (§9) | the first Registration; the endorsement Opinions that ignite the system actors; ordinarily, the first invitations |
