...
Genesis begins with money: the operator burns LBTC into a realization of the burn primitive,
funding the addresses the genesis actors act from
([economics.md §7.2](economics.md#72-the-admission-fund)). On that
footing the bootstrap establishes:

1. **The genesis member** — an ordinary account (Actor + Profile,
   own address) carrying `network_role = 'moderator'` with the
