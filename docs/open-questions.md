...
actor's address and burned admission value hang on. Two custody
...
*login*, never the L1 actor — standing, title, and the funded
...
share-holders go dark; how the address custody follows the same
