...
_Provenance: copied on 2026-08-20 from the L1 author's linter workspace, where it is design record 014, and amended in this repository since. That workspace's code is AGPL-3.0-only; its design records state no license of their own._
