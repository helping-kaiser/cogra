/* The Explore tab at rest (readme §13, the search rulings; hybrid of the
   ideation's directions 1 + 2): the search field under the brand band, the
   orbit as the hero card — item 16's future 3D view, never a small side thing
   — and the device-local recents below. Typing drops the hero off the bottom
   edge and the searching view takes the screen. */
