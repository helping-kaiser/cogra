...
- **The trigger reads back the view in words, deviations only** — "Posts" at rest, "Posts · newest · hiding seen" when flipped. No glyph: there is no filter icon in the inlined set, §5 forbids drawing one, and an icon cannot tell you Newest is on.
