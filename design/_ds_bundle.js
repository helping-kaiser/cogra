...
function TextField({
  ...
  return (
    ...
    React.createElement("div", {
      ...
      onChange: event => onChange && onChange(event.target.value),
      style: shared
    }), (error || hint || reading) && /*#__PURE__*/React.createElement("div", {
      style: {
        display: "flex",
        alignItems: "baseline",
        gap: "var(--space-2)"
