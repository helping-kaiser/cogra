...
function Count({
  ...
  }, "\xB7 ", references === 1 ? "1 reference" : `${references} references`);
}
const LINE = {
  display: "flex",
  alignItems: "center",
