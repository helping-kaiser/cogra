...
function StanceStanding({
  ...
  }, /*#__PURE__*/React.createElement(ReadoutBlock, standingParts(bundle, targetLabel, names)), /*#__PURE__*/React.createElement(ReadoutBlock, {
    big: true,
    label: PICK_LABEL,
    emoji: anchor.emoji,
...
try { (() => {
const { Card, Button, ActorChip, PendingMarker, EditedMarker, LICENSE_MENU_LABEL, StanceControl, OverflowMenu, Icon, NODE_GLYPHS, TopicsLine, MediaGallery, SensitiveVeil } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
...
function PostCard({
  ...
  React.createElement("div", {
    ...
    "aria-hidden": "true"
  }, "Cited by ", citedBy)), edited && /*#__PURE__*/React.createElement(EditedMarker, null), pending && /*#__PURE__*/React.createElement(PendingMarker, null), (showStance || score !== undefined || comments !== undefined || actions) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "nowrap",
      alignItems: "center",
...
function StanceRow({
  ...
  }, "@", handle)), /*#__PURE__*/React.createElement(StanceValue, {
    pDirected: pDirected,
    pInterest: pInterest
  }));
}
