...
function StanceControl({
  ...
  }, restingFace === null ? RESTING_FACE_EMOJI : restingFace.emoji), restingPair !== null &&
  /*#__PURE__*/
...
function CograBand({
  ...
  }, "cogra"), trailing && /*#__PURE__*/React.createElement("div", {
    style: {
      marginLeft: "auto",
      display: "flex",
      alignItems: "center",
...
try { (() => {
const { MonogramAvatar, Button, Icon, OverflowMenu, StanceControl } = __ds_scope;
...
function ProfileHeader({
  ...
  return /*#__PURE__*/React.createElement("header", {
  ...
  }, website), (posts !== undefined || stancesOn !== undefined || stancesTaken !== undefined) && (onCounts ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    size: "sm",
    onClick: onInvites
  }, "Invites"), onSettings && /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Settings",
    onClick: onSettings,
    className: "cg-state cg-focus",
    ...
    name: "settings"
  }))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(StanceControl, {
    targetLabel: "@" + handle,
    bundle: bundle ?? undefined,
    signedIn: signedIn,
    taught: taught,
