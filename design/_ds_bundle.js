...
try { (() => {
const { Icon, NODE_GLYPHS, MonogramAvatar, PendingMarker, formatStancePair, formatTagPair, nearestTagAnchor, SR_ONLY } = __ds_scope;
...
function ReferenceRow({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: SR_ONLY
  }, anchor ? `${anchor.label}, ${exact}` : exact)), pending && /*#__PURE__*/React.createElement(PendingMarker, {
    inline: true
  })));
}
...
try { (() => {
const { NodeMark, Icon, BUTTON_CLASS, formatStancePair, SR_ONLY } = __ds_scope;
...
function StanceControl({
  ...
  }, "Choose your stance on ", targetLabel)), open && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
    onPointerDown: event => {
...
function ExplainableNumber({
  ...
  }, unit) : null), exact && /*#__PURE__*/React.createElement("span", {
    style: SR_ONLY
  }, value, unit));
}
