...
Object.assign(__ds_scope, { BottomSheet, SheetItem, SheetTitle });
...
Object.assign(__ds_scope, { buttonStyle, BUTTON_CLASS, Button });
...
Object.assign(__ds_scope, { Chip, TopicChip });
...
function JoinPrompt({
  ...
  return /*#__PURE__*/React.createElement(DialogSurface, {
    ...
    type: "button",
    onClick: onClose,
    className: __ds_scope.BUTTON_CLASS,
    style: __ds_scope.buttonStyle({
      variant: "text",
      size: "sm"
    })
...
Object.assign(__ds_scope, { DialogSurface, JoinPrompt });
...
Object.assign(__ds_scope, { ATTRIBUTION_TIERS, PROVENANCE_TIERS, PUBLIC_DOMAIN, licenseTerms, LicenseChooser, LicenseTerms });
...
function RecoveryCode({
  ...
  }, explainer), /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "text",
    size: "sm",
    selfStart: true,
    onClick: onCopy
  ...
  }, "This browser would not let the page copy. Select the code and copy it yourself."), /*#__PURE__*/React.createElement(__ds_scope.TextField, {
...
Object.assign(__ds_scope, { RecoveryCode });
...
Object.assign(__ds_scope, { PendingMarker, EditedMarker });
...
Object.assign(__ds_scope, { TransportError, SigningPending });
...
Object.assign(__ds_scope, { CollapsingTop });
...
function OverflowMenu({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "more_vert"
  })), presentation === "sheet" && /*#__PURE__*/React.createElement(__ds_scope.BottomSheet, {
    open: open,
    onClose: () => setOpen(false),
    ariaLabel: ariaLabel
  }, items.map(item => /*#__PURE__*/React.createElement(__ds_scope.SheetItem, {
    key: item.label,
    label: item.label,
    onSelect: () => {
      setOpen(false);
...
Object.assign(__ds_scope, { SensitiveScope, SensitiveVeil, RedactedContent });
...
Object.assign(__ds_scope, { ALL_SLOTS, BottomNav });
...
function FeedFilter({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("button", {
  ...
  }, feedFilterSummary(value)), /*#__PURE__*/React.createElement(__ds_scope.BottomSheet, {
    open: open,
    onClose: () => setOpen(false),
    ariaLabel: ariaLabel
  }, /*#__PURE__*/React.createElement(Section, {
    label: "What gets ranked",
    hint: "Anything the network ranks can be in your feed. Combine as many as you like."
  }, FEED_KINDS.map(kind => /*#__PURE__*/React.createElement(__ds_scope.Chip, {
    key: kind.value,
    label: kind.label,
  ...
  }, FEED_FORMS.map(form => /*#__PURE__*/React.createElement(__ds_scope.Chip, {
    key: form.value,
    label: form.label,
    ...
    label: "Order",
    hint: "Ranked is the default. Newest ignores ranking and lists by time."
  }, /*#__PURE__*/React.createElement(__ds_scope.SegmentedFilter, {
    ariaLabel: "Order",
    options: FEED_ORDER,
    value: value.order,
    onChange: order => set({
    ...
    label: "Also show",
    hint: "Sensitive content stays veiled until you tap it. A removed record shows its skeleton \u2014 author, time, and place in the thread \u2014 never the content."
  }, FEED_ALSO.map(entry => /*#__PURE__*/React.createElement(__ds_scope.Chip, {
    key: entry.value,
    label: entry.label,
...
Object.assign(__ds_scope, { FEED_KINDS, FEED_FORMS, FEED_ORDER, FEED_ALSO, FEED_FILTER_DEFAULT, feedFilterSummary, FeedFilter });
...
Object.assign(__ds_scope, { MonogramAvatar, ActorChip });
...
function ExplainableNumber({
  ...
  }, glyph ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(__ds_scope.Icon, {
    name: glyph,
    size: 18
  }), /*#__PURE__*/React.createElement("span", {
    style: SR_ONLY
...
Object.assign(__ds_scope, { ExplainableNumber });
...
Object.assign(__ds_scope, { useGlobalMute, MediaAttachment, MediaGallery });
...
function MediaViewer({
  ...
  if (!item) return null;
  const arrow = direction => /*#__PURE__*/React.createElement("button", {
    type: "button",
...
Object.assign(__ds_scope, { MediaViewer });
...
Object.assign(__ds_scope, { STANCE_EXPLANATION, STANCE_PAD_HELP, STANCE_ALTERNATES_HELP, StanceCoachMark });
...
Object.assign(__ds_scope, { DIMENSION_MIN, DIMENSION_MAX, ORIGIN, TAP_DEFAULT, DIRECTED_LABEL, INTEREST_LABEL, DIRECTED_POLES, INTEREST_POLES, PICK_LABEL, SEVERED_LABEL, NO_STANDING_LABEL, ZERO_BUNDLE_EMOJI, RESTING_FACE_EMOJI, SR_ONLY, STANCE_ANCHORS, clampDimension, clampPair, nearestAnchor, bundleReadout, formatDimension, formatStancePair, formatStanceWords, localLanding, standingLine, severanceParts, landingLine, signedLine, StanceReadout, standingParts, landingParts, StanceStanding, StanceLandingLine });
...
function SeveranceConfirm({
  ...
  const pickAnchor = pick === null ? null : __ds_scope.nearestAnchor(pick);
  const read = __ds_scope.severanceParts(bundle, targetLabel);
  return /*#__PURE__*/React.createElement(__ds_scope.DialogSurface, {
    ...
    "aria-hidden": "true"
  }, "Your pick: ", pickAnchor.emoji, " ", __ds_scope.formatStancePair(pick)), /*#__PURE__*/React.createElement("span", {
    style: __ds_scope.SR_ONLY
  }, `Your pick: ${pickAnchor.label}, ${__ds_scope.formatStanceWords(pick)}`)), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: "8px 0 0",
      fontSize: "var(--text-body-medium)",
      color: "var(--text-secondary)"
...
Object.assign(__ds_scope, { SeveranceConfirm });
...
function padPairFrom(base, rect, travel, inset = KNOB_TRAVEL_INSET_PX) {
  ...
  if (halfExtent === 0) return __ds_scope.clampPair(base);
  return __ds_scope.clampPair({
...
function padPercentOf(pair) {
  return {
    x: 50 + __ds_scope.clampDimension(pair.pDirected) * 50,
    y: 50 - __ds_scope.clampDimension(pair.pInterest) * 50
  };
}
function StancePad({
  value = __ds_scope.ORIGIN,
  onChange,
  fieldRef,
  showAxes = true
}) {
...
Object.assign(__ds_scope, { FIELD_CORNER_RADIUS_PX, KNOB_DIAMETER_PX, knobTravelInset, KNOB_TRAVEL_INSET_PX, padTravelHalfExtent, padPairFrom, padPercentOf, StancePad });
...
function StanceSlider({
  ...
  }, label, " ", __ds_scope.formatDimension(value)), /*#__PURE__*/React.createElement("input", {
    id: fieldId,
    type: "range",
    min: -1,
    max: 1,
...
Object.assign(__ds_scope, { StanceSlider });
...
function DirectEntry({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    step: 0.01,
    value: value,
    onChange: event => onChange && onChange(__ds_scope.clampDimension(Number(event.target.value))),
    style: {
      width: "6rem",
      borderRadius: "var(--radius-extra-small)",
      border: "1px solid var(--border-field)",
...
function StanceAlternates({
  ...
  }, __ds_scope.STANCE_ALTERNATES_HELP.map(line => /*#__PURE__*/React.createElement("p", {
    key: line,
    style: {
      margin: 0,
      fontSize: "var(--text-body-small)",
  ...
  }, showing === "sliders" ? /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(__ds_scope.StanceSlider, {
    label: __ds_scope.DIRECTED_LABEL,
    minLabel: __ds_scope.DIRECTED_POLES[0],
    maxLabel: __ds_scope.DIRECTED_POLES[1],
    value: pick.pDirected,
    onChange: pDirected => onPick && onPick({
      ...pick,
      pDirected
    })
  }), /*#__PURE__*/React.createElement(__ds_scope.StanceSlider, {
    label: __ds_scope.INTEREST_LABEL,
    minLabel: __ds_scope.INTEREST_POLES[0],
    maxLabel: __ds_scope.INTEREST_POLES[1],
...
Object.assign(__ds_scope, { StanceAlternates });
...
const EMPTY_BUNDLE = {
  current: __ds_scope.ORIGIN,
  rawSum: __ds_scope.ORIGIN,
  records: 0,
  severed: false,
  severance: {
    records: 0
...
function StanceControl({
  ...
  const [explaining, setExplaining] = React.useState(false);
  const [pick, setPick] = React.useState(__ds_scope.ORIGIN);
  ...
  const landing = considered ? __ds_scope.localLanding(bundle.rawSum, pick) : null;
  const clearHold = () => {
  ...
  const apply = (chosen, landed, records = 1) => {
    ...
    const next = {
      ...
      rawSum: landed.severed ? __ds_scope.ORIGIN : rawSum,
    ...
    setBundle(next);
    setSigned(__ds_scope.signedLine(landed.landing, records, landed.severed, targetLabel));
    if (onCommit) onCommit(__ds_scope.clampPair(chosen), next);
  };
  const commitChecked = chosen => {
    const landed = __ds_scope.localLanding(bundle.rawSum, chosen);
    closeAll();
    if (landed.severed) {
      setConfirming({
        pick: chosen,
  ...
  const onTap = () => {
    ...
    commitChecked(__ds_scope.TAP_DEFAULT);
  };
  const onPointerDown = () => {
    if (!signedIn) return;
    clearHold();
  ...
  const restingFace = restingPair === null ? null : __ds_scope.bundleReadout(restingPair);
  return /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      display: "flex",
    ...
    type: "button",
    "aria-label": restingFace === null ? `Take a stance on ${targetLabel}` : `Your stance on ${targetLabel}: ${restingFace.label}, ${__ds_scope.formatStancePair(restingPair)}. Tap to add a positive one.`,
    onClick: onTap,
    onPointerDown: onPointerDown,
  ...
  }, restingFace === null ? __ds_scope.RESTING_FACE_EMOJI : restingFace.emoji), restingPair !== null &&
  /*#__PURE__*/
  ...
  React.createElement("span", {
  ...
  }, __ds_scope.formatStancePair(restingPair))), signedIn && /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: () => {
      setPick(__ds_scope.ORIGIN);
      setSigned(null);
    ...
    className: `cg-sr-focusable ${__ds_scope.BUTTON_CLASS}`,
    style: {
      fontFamily: "var(--font-sans)"
    }
  }, "Choose your stance")), coach && /*#__PURE__*/React.createElement(__ds_scope.StanceCoachMark, {
  ...
  }, "?")), /*#__PURE__*/React.createElement(__ds_scope.StanceStanding, {
    pick: pick,
    bundle: bundle,
  ...
  }, __ds_scope.STANCE_PAD_HELP.map(line => /*#__PURE__*/React.createElement("p", {
    key: line,
    style: {
      margin: 0,
      fontSize: "var(--text-body-small)",
  ...
  }, "Back to the pad")) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(__ds_scope.StancePad, {
    value: pick,
    onChange: setPick,
    fieldRef: fieldRef
  }), /*#__PURE__*/React.createElement(__ds_scope.StanceLandingLine, {
    landing: landing
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
  ...
  }, "Set")))), alternates && /*#__PURE__*/React.createElement(__ds_scope.StanceAlternates, {
    pick: pick,
    onPick: setPick,
    onCommit: () => commitChecked(pick),
    onCancel: closeAll,
    onSever: openSeverance,
    landing: /*#__PURE__*/React.createElement(__ds_scope.StanceLandingLine, {
      landing: landing
    })
  }, /*#__PURE__*/React.createElement(__ds_scope.StanceStanding, {
    pick: pick,
    bundle: bundle,
    targetLabel: targetLabel
  })), confirming !== null && /*#__PURE__*/React.createElement(__ds_scope.SeveranceConfirm, {
    ...
    onConfirm: () => {
      apply(confirming.pick ?? __ds_scope.ORIGIN, confirming.landed, Math.max(1, confirming.records));
      setConfirming(null);
    }
  }), /*#__PURE__*/React.createElement(__ds_scope.Snackbar, {
    message: signed,
    onDismiss: () => setSigned(null)
  }), joinPrompt && /*#__PURE__*/React.createElement(__ds_scope.JoinPrompt, {
    open: true,
    onClose: () => setJoinPrompt(false)
  }));
}
Object.assign(__ds_scope, { LONG_PRESS_MS, StanceControl });
...
function CommentCard({
  ...
  }, author && /*#__PURE__*/React.createElement(__ds_scope.ActorChip, {
  ...
  }, timestamp), /*#__PURE__*/React.createElement(__ds_scope.OverflowMenu, {
    items: items,
  ...
  }, content), license && showLicense && /*#__PURE__*/React.createElement(__ds_scope.LicenseTerms, {
    license: license
  }), edited && /*#__PURE__*/React.createElement(__ds_scope.EditedMarker, null), pending && /*#__PURE__*/React.createElement(__ds_scope.PendingMarker, null), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      alignItems: "center",
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.StanceControl, {
    targetLabel: targetLabel,
    bundle: bundle ?? undefined,
    signedIn: signedIn,
    taught: taught,
    onCommit: onCommit
  }), signedIn && onReply && /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "text",
    size: "sm",
    onClick: onReply
  }, "Reply"), signedIn && own && onEdit && /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "text",
    size: "sm",
    onClick: onEdit
...
function PostCard({
  ...
  React.createElement("div", {
    ...
    items: media,
    radius: "0px"
  })), viewing !== null && /*#__PURE__*/React.createElement(__ds_scope.MediaViewer, {
    items: media,
    index: viewing,
    onClose: () => setViewing(null)
  }), redacted ? /*#__PURE__*/React.createElement(__ds_scope.RedactedContent, redacted === true ? {} : redacted) : linkedText, !redacted && opener, license && showLicense && !redacted && /*#__PURE__*/React.createElement(__ds_scope.LicenseTerms, {
    license: license
  }), edited && /*#__PURE__*/React.createElement(__ds_scope.EditedMarker, null), pending && /*#__PURE__*/React.createElement(__ds_scope.PendingMarker, null), (showStance || score !== undefined || comments !== undefined || actions) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "nowrap",
      alignItems: "center",
  ...
  }, showStance && /*#__PURE__*/React.createElement(__ds_scope.StanceControl, {
    targetLabel: targetLabel,
    bundle: bundle ?? undefined,
    signedIn: signedIn,
    taught: taught,
    onCommit: onCommit
  }), score !== undefined && /*#__PURE__*/React.createElement(__ds_scope.ExplainableNumber, {
    glyph: "graph",
    label: "Post Score",
    value: score,
...
function ProfileHeader({
  ...
  return /*#__PURE__*/React.createElement("header", {
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.MonogramAvatar, {
    name: name,
    size: "lg",
    src: avatarSrc
  }), /*#__PURE__*/React.createElement("div", {
  ...
  }, "@", handle))), bio && /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: "var(--text-body-medium)",
      lineHeight: "var(--text-body-medium--line-height)"
    }
  }, bio), (stancesOn !== undefined || stancesTaken !== undefined) && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      gap: "var(--space-6)"
    }
  ...
  }, own ? /*#__PURE__*/React.createElement(React.Fragment, null, onEdit && /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "outline",
    size: "sm",
    onClick: onEdit
  }, "Edit profile"), onSettings && /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-label": "Settings",
    onClick: onSettings,
    className: "cg-state cg-focus",
    ...
    name: "settings"
  }))) : /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(__ds_scope.StanceControl, {
    targetLabel: "@" + handle,
    bundle: bundle ?? undefined,
    signedIn: signedIn,
    taught: taught,
  ...
  }, /*#__PURE__*/React.createElement(__ds_scope.OverflowMenu, {
    items: menuItems,
    ariaLabel: "More about @" + handle
  })))));
}
...
function EmptyState({
  ...
  }, title), action ?? (actionLabel && onAction ? /*#__PURE__*/React.createElement(__ds_scope.Button, {
    variant: "outline",
    size: "sm",
    selfStart: true,
    onClick: onAction
...
function TopBar({
  ...
  }, "cogra")), guest && /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "center",
      justifyContent: "space-between",
  ...
  }, "You're browsing as a guest \u2014 sign in or join to post and vouch."), /*#__PURE__*/React.createElement("div", {
    style: {
      flex: "none"
    }
  }, /*#__PURE__*/React.createElement(Button, {
...
function Feed({
  ...
  return /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(CollapsingTop, {
  ...
  }, state === "offline" && /*#__PURE__*/React.createElement(TransportError, {
    message: "Can't reach the server \u2014 new posts can't load right now."
  }), state === "loading" && /*#__PURE__*/React.createElement(LoadingState, null), state === "empty" && /*#__PURE__*/React.createElement(EmptyState, {
    title: "Nothing here yet \u2014 write the first post.",
    actionLabel: "New post",
    onAction: guest ? onJoin : undefined
  }), state !== "loading" && state !== "empty" && posts.map(post => /*#__PURE__*/React.createElement(PostCard, {
    key: post.id,
    variant: "summary",
    author: post.author,
    title: post.title,
...
function Thread({
  ...
  }, comments.length === 0 ? "No comments yet." : comments.length === 1 ? "1 comment" : comments.length + " comments"), comments.length > 0 && /*#__PURE__*/React.createElement("ul", {
    style: {
      listStyle: "none",
      margin: 0,
      padding: 0,
  ...
  }, comments.map(comment => /*#__PURE__*/React.createElement(CommentCard, _extends({
    key: comment.id
  }, decorate(comment))))))));
}
function Phone({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    className: dir === "back" ? "cg-nav-back-in" : "cg-nav-in"
  }, post ? /*#__PURE__*/React.createElement(Thread, {
    post: post,
    guest: guest,
    bundles: bundles,
    taught: taught,
    ...
    onOpenComments: id => open(id, true),
    onCommit: commit,
    onJoin: () => setJoining(true)
  }))), /*#__PURE__*/React.createElement(BottomNav, {
    active: view.name === "feed" ? "feed" : null,
    slots: ["feed", "compose", "profile"],
    onSelect: slot
  }), /*#__PURE__*/React.createElement(JoinPrompt, {
    open: joining,
    onClose: () => setJoining(false),
    onSignIn: () => {
      setJoining(false);
      setNote("Joining is a session of its own.");
    }
...
function Session() {
  ...
  const Group = ({
    ...
    key: option.value,
    className: "ctl-btn" + (value === option.value ? " on" : ""),
    onClick: () => onPick(option.value)
  }, option.label))));
  return /*#__PURE__*/React.createElement("div", {
    className: "desk"
  }, /*#__PURE__*/React.createElement(Phone, {
    key: run + ":" + guest + ":" + feedState,
    guest: guest,
    feedState: feedState
  ...
  }, "Core loop \u2014 feed, post, stance"), /*#__PURE__*/React.createElement("p", {
    className: "text-body-small",
    style: {
      margin: 0,
      color: "var(--text-secondary)"
    }
  }, "Backlog item 1. Built only from components already in the system. Hold a stance target for half a second to bloom the pad; release parks the pick, ", /*#__PURE__*/React.createElement("b", null, "Set"), " signs it. The first tap ever teaches and signs nothing."), /*#__PURE__*/React.createElement(Group, {
    label: "Theme",
  ...
  }, "Reset the session"), /*#__PURE__*/React.createElement("p", {
    className: "text-body-small",
    style: {
      margin: 0,
      color: "var(--text-secondary)"
...
if (mount) ReactDOM.createRoot(mount).render(/*#__PURE__*/React.createElement(Session, null));
})(); } catch (e) { __ds_ns.__errors.push({ path: "designs/core-loop/app.jsx", error: String((e && e.message) || e) }); }

// designs/core-loop/data.jsx
try { (() => {
...
const POSTS = [{
  ...
  content: "The light does something at the third headland that I have never managed to photograph properly, and I have tried maybe a dozen times now. This is the closest I have come.",
  timestamp: "2h",
  score: "15.20",
  comments: 3,
  media: [{
    src: PHOTOS + "03-landscape-16x9.jpg",
    ratio: "landscape",
    alt: "A coast road curving around a headland at low sun."
  }],
  ...
  content: "Spent the morning re-reading the routing notes from March. Half of what we argued about turned out to be the same disagreement wearing two different words.",
  timestamp: "5h",
  score: "8.40",
  comments: 1,
  ...
  edited: true,
  media: [{
    src: PHOTOS + "05-portrait-4x5.jpg",
    ratio: "portrait",
    alt: "A dog asleep in a patch of sun on a wooden floor."
  }, {
    src: PHOTOS + "10-square-1x1.jpg",
    ratio: "square"
  }, {
    src: PHOTOS + "04-square-1x1.jpg",
    ratio: "square"
  }, {
    src: PHOTOS + "09-landscape-4x3.jpg",
    ratio: "landscape"
  }],
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "designs/core-loop/data.jsx", error: String((e && e.message) || e) }); }
