...
const BUTTON_CLASS = "cg-state cg-focus cg-hit";
...
const HISTORY_DOOR_TAIL = " · see how it built";
 ...
 *  clamps. */
function nearestValenceAnchor(pDirected) {
...
function formatDimension(value) {
  return DIMENSION_FORMAT.formatToParts(value).map(part => part.type === "minusSign" ? MINUS_SIGN : part.value).join("");
}
...
function formatStanceWords(pair, names = STANCE_AXIS_NAMES) {
...
function signedLine(standing, records, severed, targetLabel, names = STANCE_AXIS_NAMES) {
...
function StanceReadout({
  ...
  return /*#__PURE__*/React.createElement(ReadoutLine, {
    emoji: readout.emoji,
...
function OwnStanceReadout({
  ...
  return /*#__PURE__*/React.createElement(ReadoutLine, {
    emoji: band.emoji,
    exact: exact,
    spoken: `${band.label}, ${DIRECTED_LABEL} ${exact}`,
    style: style
  });
}

/** The bundle, split for rendering: either a sentence, or a readout to lay out. */
function standingParts(bundle, targetLabel, names = STANCE_AXIS_NAMES) {
  const sever = severanceWords(names);
  if (bundle === undefined) return {
    sentence: "Checking your current opinion…"
  };
...
function landingParts(landing, names = STANCE_AXIS_NAMES) {
...
__ds_scope.STANCE_AXIS_NAMES = STANCE_AXIS_NAMES;
__ds_scope.PICK_LABEL = PICK_LABEL;
__ds_scope.HISTORY_DOOR_TAIL = HISTORY_DOOR_TAIL;
__ds_scope.SEVERED_LABEL = SEVERED_LABEL;
__ds_scope.NO_STANDING_LABEL = NO_STANDING_LABEL;
__ds_scope.STANCE_SEVERANCE_WORDS = STANCE_SEVERANCE_WORDS;
__ds_scope.severanceWords = severanceWords;
...
__ds_scope.VALENCE_SIX = VALENCE_SIX;
...
__ds_scope.nearestValenceAnchor = nearestValenceAnchor;
...
const PATHS = {
  ...
  lock_outline: ["M12,17c1.1,0,2-0.9,2-2s-0.9-2-2-2s-2,0.9-2,2S10.9,17,12,17z M18,8h-1V6c0-2.76-2.24-5-5-5S7,3.24,7,6v2H6 c-1.1,0-2,0.9-2,2v10c0,1.1,0.9,2,2,2h12c1.1,0,2-0.9,2-2V10C20,8.9,19.1,8,18,8z M8.9,6c0-1.71,1.39-3.1,3.1-3.1 s3.1,1.39,3.1,3.1v2H8.9V6z M18,20H6V10h12V20z"],
  ...
  /* The chat foot's voice note (the chats integration round, post-MVP,
     2026-09-24): hold to record. Classic filled `mic` (av/mic), verbatim from
     material-design-icons, the background rect stripped per the set's rule. */
...
function ActsFooter({
  ...
  const line = count === 0 ? "Nothing to sign yet" : count === 1 ? "You're signing 1 thing" : `You're signing ${count} things`;
  const style = {
    display: "flex",
    alignItems: "center",
    justifyContent: "center",
    ...
    style: {
      ...
      ...(inline ? {
        ...
        ...(tallest ? {
          ...
          height: `min(${height}, ${SHEET_CEILING})`,
          overflow: "hidden"
        } : {
          maxHeight: `min(${maxHeight}, ${SHEET_CEILING})`,
          overflowY: "auto"
        })
      })
    }
...
function ReferenceRow({
  ...
  return /*#__PURE__*/React.createElement("button", {
    ...
    style: SR_ONLY
  }, spokenWord && anchor ? `${anchor.label}, ${exact}` : exact)), pending && /*#__PURE__*/React.createElement(PendingMarker, {
    inline: true
  })));
}
...
function StagedReference({
  ...
  }, body) : body, /*#__PURE__*/React.createElement("button", {
    type: "button",
...
function MediaThumb({
  ...
  }, "Cover"), coverSrc && /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      left: "3px",
      bottom: "3px",
  ...
  })), typeof progress === "number" && !failed && /*#__PURE__*/React.createElement("span", {
    style: {
      position: "absolute",
      inset: 0,
...
__ds_scope.TopicRemovable = TopicRemovable;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/compose/TopicRemovable.jsx", error: String((e && e.message) || e) }); }

// components/compose/TagsSheet.jsx
try { (() => {
const { BottomSheet, SheetTitle, Button, TopicRemovable } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
...
function TagsSheet({
  ...
  return /*#__PURE__*/React.createElement(BottomSheet, {
    open: open,
    onClose: onClose,
    ariaLabel: `Tags · ${items.length}`,
    inline: inline,
    maxHeight: "88%"
  }, /*#__PURE__*/React.createElement(SheetTitle, null, "Tags \xB7 ", items.length), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      flexWrap: "wrap",
      gap: 8,
  ...
  }, items.map((item, index) => /*#__PURE__*/React.createElement(TopicRemovable, _extends({
...
__ds_scope.TagsSheet = TagsSheet;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/compose/TagsSheet.jsx", error: String((e && e.message) || e) }); }

// components/compose/WizardFooter.jsx
try { (() => {
const { Button } = __ds_scope;
...
__ds_scope.WizardFooter = WizardFooter;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/compose/WizardFooter.jsx", error: String((e && e.message) || e) }); }
...
function PageHeader({
  ...
  }, (backHref || onBack) && /*#__PURE__*/React.createElement("a", {
    href: backHref ?? "#",
...
// components/compose/WizardHeader.jsx
try { (() => {
const { HelpDot, PageHeader, Icon } = __ds_scope;
...
function WizardHeader({
  ...
  return /*#__PURE__*/React.createElement(PageHeader, {
    ...
    }, stageLabel), help && /*#__PURE__*/React.createElement(HelpDot, {
      ariaLabel: help,
      onOpen: onHelp
    })) : help && /*#__PURE__*/React.createElement(HelpDot, {
      ariaLabel: help,
      onOpen: onHelp
    }), action)
  });
}
__ds_scope.WizardHeader = WizardHeader;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/compose/WizardHeader.jsx", error: String((e && e.message) || e) }); }
...
// components/forms/LicenseChooser.jsx
try { (() => {
...
const ATTRIBUTION_TIERS = [{
  value: 0,
  label: "No credit",
  hint: "Nobody owes you a name."
}, {
  value: 0.5,
...
const LICENSE_MENU_LABEL = "License terms";
...
function licenseReadings(license) {
  return [{
    axis: "Credit",
    reading: READER_READINGS.attribution[license.attribution] ?? `Owed to degree ${license.attribution}`
  }, {
...
function AxisChoice({
  ...
  }, tiers.map(tier => /*#__PURE__*/React.createElement("label", {
    key: tier.value,
    style: {
      display: "flex",
      alignItems: "center",
...
function LicenseChooser({
  ...
  }, "Terms for anyone who reuses this \u2014 not a statement about how you made it."), /*#__PURE__*/React.createElement(AxisChoice, {
    legend: "Credit",
    tiers: ATTRIBUTION_TIERS,
    name: `${name}-attribution`,
    value: value.attribution,
    onChange: attribution => onChange && onChange({
      ...value,
      attribution
    })
  }), /*#__PURE__*/React.createElement(AxisChoice, {
    legend: "Public record of use",
    tiers: PROVENANCE_TIERS,
    name: `${name}-provenance`,
    value: value.provenance,
    onChange: provenance => onChange && onChange({
      ...value,
      provenance
    })
  }));
...
function LicenseTerms({
  ...
  }, "License terms"), publicDomain && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-label-small)",
      lineHeight: "var(--text-label-small--line-height)",
      fontWeight: "var(--text-label-small--font-weight)"
    }
  }, "Public domain")), /*#__PURE__*/React.createElement("div", {
    style: {
      display: "grid",
  ...
  }, licenseReadings(license).map(row => /*#__PURE__*/React.createElement(React.Fragment, {
    key: row.axis
  }, /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-body-small)",
  ...
  }, row.axis), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-body-small)",
      lineHeight: "var(--text-body-small--line-height)"
    }
...
__ds_scope.ATTRIBUTION_TIERS = ATTRIBUTION_TIERS;
__ds_scope.PROVENANCE_TIERS = PROVENANCE_TIERS;
...
function Snackbar({
  ...
  return /*#__PURE__*/React.createElement("div", {
    role: "status",
    "aria-live": "polite"
  }, message !== null && message !== undefined && /*#__PURE__*/React.createElement("div", {
    style: {
      ...placement,
      width: "fit-content",
...
const AXIS_GUTTER_X_PX = 56;
const AXIS_GUTTER_Y_PX = 20;
const FIELD_CORNER_RADIUS_PX = 16;
const KNOB_DIAMETER_PX = 20;
function knobTravelInset(cornerRadius = FIELD_CORNER_RADIUS_PX, knobDiameter = KNOB_DIAMETER_PX) {
  const knobRadius = knobDiameter / 2;
  return Math.max(knobRadius, cornerRadius - (cornerRadius - knobRadius) / Math.SQRT2);
}
const KNOB_TRAVEL_INSET_PX = knobTravelInset();
function padTravelHalfExtent(rect, inset = KNOB_TRAVEL_INSET_PX) {
...
function padPairFrom(base, rect, travel, inset = KNOB_TRAVEL_INSET_PX, ranges = STANCE_RANGES) {
...
function padPercentOf(pair, ranges = STANCE_RANGES) {
...
function StancePad({
  ...
  const onPointerMove = event => {
    ...
    onChange(padPairFrom(from.base, field.getBoundingClientRect(), {
      dx: event.clientX - from.x,
      dy: event.clientY - from.y
    }, KNOB_TRAVEL_INSET_PX, ranges));
  };
  const endDrag = () => {
    drag.current = null;
  };
...
__ds_scope.AXIS_GUTTER_X_PX = AXIS_GUTTER_X_PX;
__ds_scope.AXIS_GUTTER_Y_PX = AXIS_GUTTER_Y_PX;
__ds_scope.FIELD_CORNER_RADIUS_PX = FIELD_CORNER_RADIUS_PX;
__ds_scope.KNOB_DIAMETER_PX = KNOB_DIAMETER_PX;
__ds_scope.knobTravelInset = knobTravelInset;
__ds_scope.KNOB_TRAVEL_INSET_PX = KNOB_TRAVEL_INSET_PX;
__ds_scope.padTravelHalfExtent = padTravelHalfExtent;
__ds_scope.padPairFrom = padPairFrom;
__ds_scope.padPercentOf = padPercentOf;
__ds_scope.StancePad = StancePad;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/stance/StancePad.jsx", error: String((e && e.message) || e) }); }
...
function StanceAlternates({
  ...
  }, alternatesHelp(axes).map(line => /*#__PURE__*/React.createElement("p", {
    key: helpKey(line),
    style: {
      margin: 0,
      fontSize: "var(--text-body-small)",
...
function StanceControl({
  ...
  const apply = (chosen, landed, records = 1) => {
    const rawSum = {
      pDirected: bundle.rawSum.pDirected + chosen.pDirected,
      pInterest: bundle.rawSum.pInterest + chosen.pInterest
    };
    const next = {
  ...
  const commitChecked = chosen => {
    ...
    if (landed.severed) {
      setConfirming({
        pick: chosen,
        records: Math.max(1, bundle.records),
        landed
      });
      return;
    }
  ...
  React.createElement("span", {
  ...
  }, "?")), /*#__PURE__*/React.createElement(StanceStanding, {
    pick: pick,
    bundle: bundle,
  ...
  }, padHelp(axes).map(line => /*#__PURE__*/React.createElement("p", {
    key: helpKey(line),
    style: {
      margin: 0,
      fontSize: "var(--text-body-small)",
  ...
  }, !firstConnection && (bundle.records > 0 || bundle.severed === true) && /*#__PURE__*/React.createElement("button", {
    type: "button",
    ...
    landing: /*#__PURE__*/React.createElement(StanceLandingLine, {
      landing: landing,
      names: axes
    }),
    helpLabel: helpLabel,
    ...
    names: axes,
    onOpenHistory: onOpenHistory
  })), confirming !== null && /*#__PURE__*/React.createElement(SeveranceConfirm, {
    ...
    message: signed,
    onDismiss: () => setSigned(null)
  }), joinPrompt && /*#__PURE__*/React.createElement(JoinPrompt, {
    open: true,
    onClose: () => setJoinPrompt(false)
  }));
}
__ds_scope.LONG_PRESS_MS = LONG_PRESS_MS;
...
function OverflowMenu({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    ariaLabel: ariaLabel
  }, items.map(item => /*#__PURE__*/React.createElement(SheetItem, {
    key: item.label,
    label: item.label,
    onSelect: () => {
      setOpen(false);
  ...
  }))), presentation === "menu" && open && /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement("div", {
    "aria-hidden": "true",
...
// components/media/VideoControls.jsx
try { (() => {
const { Icon } = __ds_scope;
...
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/VideoControls.jsx", error: String((e && e.message) || e) }); }
...
/* PROPOSED — design.md §6's "media attachment", with the two rules that were open
   ...
   · THE STAGE LAW (jakob 2026-09-23, the feed-video rulings). One stage per
     ...
     nothing takes it from a clip that still qualifies, so scrolling back up
     never ricochets playback. The instant the incumbent falls below the gate
     the stage re-evaluates — MID-SCROLL, NEVER WAITING FOR SETTLE ("users are
     not used to even stop scrolling anymore") — and the topmost qualifying
...
function CommentCard({
  ...
  const items = license && !redacted ? [...menuItems, {
    label: LICENSE_MENU_LABEL,
    onSelect: () => {}
  }] : menuItems;
  ...
  return /*#__PURE__*/React.createElement("li", {
    ...
    name: targetKind === "post" ? "dynamic_feed" : NODE_GLYPHS[targetKind] ?? "dynamic_feed",
    size: 14,
    style: {
      flex: "none"
    }
    ...
    size: "sm",
    onClick: onReply
  }, "Reply"), signedIn && own && onEdit && /*#__PURE__*/React.createElement(Button, {
    variant: "text",
    size: "sm",
    onClick: onEdit
  ...
  }, replies.map(reply => /*#__PURE__*/React.createElement(CommentCard, _extends({
    key: reply.id
  }, reply, {
    depth: depth + 1,
    signedIn: signedIn
...
function PostCard({
  ...
  const heading = title ? /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0,
  ...
  const contentStyle = {
    ...
    ...(detail ? {
      whiteSpace: "pre-wrap"
    } : open ? null : CLAMP(TEXT_BODY_CLAMP_LINES))
  };
  ...
  const folded = hasMedia ? Boolean(description) : words && words.length > TEXT_BODY_CLAMP_LINES * CHARS_PER_LINE || description && description.length > DESCRIPTION_CLAMP_LINES * CHARS_PER_LINE;
  const opener = !detail && folded ? /*#__PURE__*/React.createElement("button", {
    type: "button",
    "aria-expanded": open,
    onClick: () => setOpen(shown => !shown),
    className: "cg-state cg-focus",
...
// components/core/ContentRow.jsx
try { (() => {
const { Icon, MonogramAvatar, PendingMarker, StanceValue } = __ds_scope;
...
function Disc({
  ...
  if (name) return /*#__PURE__*/React.createElement(MonogramAvatar, {
    name: name,
    size: 40
  });
  return /*#__PURE__*/React.createElement("span", {
  ...
  }, face ? /*#__PURE__*/React.createElement(StanceValue, {
    pDirected: face.pDirected,
    pInterest: face.pInterest,
    showPair: false
...
function ContentRow({
  ...
  const heading = /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-label-large)",
      lineHeight: "var(--text-label-large--line-height)",
      fontWeight: "var(--text-label-large--font-weight)",
  ...
  }, titleAside ? /*#__PURE__*/React.createElement("span", {
    style: {
      display: "flex",
      alignItems: "baseline",
      gap: "var(--space-2)",
...
function FactRow({
  ...
  const wrapped = value != null && (typeof value === "string" || shape.wrapNodes) ? /*#__PURE__*/React.createElement("span", {
    style: {
      ...type,
      ...shape.value
    }
  ...
  }, label), wrapped, typeof action === "string" ? /*#__PURE__*/React.createElement(InlineAction, {
    onClick: onAction
  }, action) : action);
}
__ds_scope.FactRow = FactRow;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/FactRow.jsx", error: String((e && e.message) || e) }); }
...
function CgtMark({
  ...
  return /*#__PURE__*/React.createElement("svg", {
    ...
    transform: "translate(2.26 2.26) scale(0.155)",
    fill: "none",
...
function MoneyFigure({
  ...
  }, sign, formatCgt(amount), " ", /*#__PURE__*/React.createElement(CgtMark, null), unit ? " CGT" : /*#__PURE__*/React.createElement("span", {
    style: SR_ONLY
  }, "CGT"));
}
__ds_scope.formatCgt = formatCgt;
__ds_scope.CgtMark = CgtMark;
__ds_scope.MoneyFigure = MoneyFigure;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/MoneyFigure.jsx", error: String((e && e.message) || e) }); }

// components/core/QuietNote.jsx
try { (() => {
...
__ds_scope.QuietNote = QuietNote;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/QuietNote.jsx", error: String((e && e.message) || e) }); }

// components/core/QuotedRow.jsx
try { (() => {
const { MonogramAvatar } = __ds_scope;
...
__ds_scope.QuotedRow = QuotedRow;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/QuotedRow.jsx", error: String((e && e.message) || e) }); }
...
__ds_scope.SectionLabel = SectionLabel;
...
function SettingsGroup({
  ...
  }, rows.map((row, index) => /*#__PURE__*/React.createElement(React.Fragment, {
    key: index
...
__ds_scope.SettingsRow = SettingsRow;
__ds_scope.SettingsGroup = SettingsGroup;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/core/SettingsRow.jsx", error: String((e && e.message) || e) }); }
...
try { (() => {
const { BUTTON_CLASS, Icon } = __ds_scope;
...
__ds_scope.PasswordField = PasswordField;
...
try { (() => {
const { Button, TextField } = __ds_scope;
...
function RecoveryCode({
  ...
  }, explainer), /*#__PURE__*/React.createElement(Button, {
    variant: "text",
    size: "sm",
    selfStart: true,
    onClick: onCopy
  }, "Copy"), copyFailed && /*#__PURE__*/React.createElement("p", {
    role: "status",
    style: {
      margin: 0,
      fontSize: "var(--text-body-medium)"
    }
  }, "This browser would not let the page copy. Select the code and copy it yourself."), /*#__PURE__*/React.createElement(TextField, {
    label: "Type or paste the code to confirm",
    mono: true,
    value: typedBack,
    onChange: setTypedBack,
    error: diverged ? error : undefined
  }), /*#__PURE__*/React.createElement(Button, {
    size: "sm",
    selfStart: true,
    disabled: !matches,
...
__ds_scope.RecoveryCode = RecoveryCode;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/forms/RecoveryCode.jsx", error: String((e && e.message) || e) }); }
...
function SearchBar({
  ...
  }, query || placeholder), query && /*#__PURE__*/React.createElement("span", {
    "aria-hidden": "true",
    style: {
      marginLeft: "auto",
      width: "2px",
...
function PinnedClip({
  ...
  const clip = /*#__PURE__*/React.createElement(MediaAttachment, _extends({}, item, {
...
__ds_scope.PinnedClip = PinnedClip;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/PinnedClip.jsx", error: String((e && e.message) || e) }); }

// components/media/ReelCaption.jsx
try { (() => {
...
function ReelCaption({
  ...
  }, "@", handle), title && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-title-small)",
      lineHeight: "var(--text-title-small--line-height)",
      fontWeight: "var(--text-title-small--font-weight)"
...
__ds_scope.ReelCaption = ReelCaption;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/ReelCaption.jsx", error: String((e && e.message) || e) }); }

// components/media/ReelRail.jsx
try { (() => {
const { Icon, MonogramAvatar, StanceControl, ExplainableNumber } = __ds_scope;
...
function ReelRail({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    targetLabel: "this post",
    overMedia: true
  }), comments !== undefined && /*#__PURE__*/React.createElement(ReelRailItem, {
    label: comments === 1 ? "1 comment" : `${comments} comments`,
    glyph: "chat_bubble",
    count: comments,
    onClick: onOpenComments
  }), /*#__PURE__*/React.createElement(ReelRailItem, {
...
__ds_scope.ReelRailItem = ReelRailItem;
__ds_scope.ReelRail = ReelRail;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/media/ReelRail.jsx", error: String((e && e.message) || e) }); }

// components/navigation/BackToTop.jsx
try { (() => {
const { BUTTON_CLASS } = __ds_scope;
...
__ds_scope.BackToTop = BackToTop;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/BackToTop.jsx", error: String((e && e.message) || e) }); }

// components/navigation/BorrowedViewBand.jsx
try { (() => {
const { MonogramAvatar, buttonStyle, BUTTON_CLASS } = __ds_scope;
...
__ds_scope.BorrowedViewBand = BorrowedViewBand;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/BorrowedViewBand.jsx", error: String((e && e.message) || e) }); }
...
const ALL_SLOTS = ["feed", "search", "compose", "wallet", "profile"];
...
function BottomNav({
  ...
  return /*#__PURE__*/React.createElement("nav", {
    ...
    const glyph = slot === "profile" && resolved.profile === undefined ? selected ? "person" : "person_outline" : resolved[slot] ?? "person_outline";
    return /*#__PURE__*/React.createElement("button", {
      key: slot,
      type: "button",
...
__ds_scope.ALL_SLOTS = ALL_SLOTS;
__ds_scope.BottomNav = BottomNav;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/BottomNav.jsx", error: String((e && e.message) || e) }); }

// components/navigation/CograBand.jsx
try { (() => {
const { Icon } = __ds_scope;
...
function CograBand({
  ...
  return /*#__PURE__*/React.createElement("div", {
    ...
    name: "mark",
    size: 24,
    pickColor: "var(--primary-container)"
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-title-large)",
      lineHeight: "var(--text-title-large--line-height)",
...
// components/navigation/CollapsingTop.jsx
try { (() => {
...
__ds_scope.SegmentedFilter = SegmentedFilter;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/SegmentedFilter.jsx", error: String((e && e.message) || e) }); }

// components/navigation/OrderSection.jsx
try { (() => {
const { SegmentedFilter, Checkbox } = __ds_scope;
...
__ds_scope.FilterSection = FilterSection;
__ds_scope.OrderSection = OrderSection;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/navigation/OrderSection.jsx", error: String((e && e.message) || e) }); }

// components/navigation/FeedFilter.jsx
try { (() => {
const { BottomSheet, Chip, Button, FilterSection, OrderSection, FILTER_ORDER, HelpDot } = __ds_scope;
function _extends() { return _extends = Object.assign ? Object.assign.bind() : function (n) { for (var e = 1; e < arguments.length; e++) { var t = arguments[e]; for (var r in t) ({}).hasOwnProperty.call(t, r) && (n[r] = t[r]); } return n; }, _extends.apply(null, arguments); }
...
function FeedFilterSheet({
  ...
  const sections = /*#__PURE__*/React.createElement(React.Fragment, null, /*#__PURE__*/React.createElement(FilterSection, {
    ...
    key: kind.value,
    label: kind.label,
    selected: (value.kinds || []).includes(kind.value),
    onToggle: () => toggle("kinds", kind.value)
  }))), /*#__PURE__*/React.createElement(FilterSection, {
    label: "Kinds of post",
    hint: postsish ? "Combine them: photos and video with no text posts is a legitimate feed." : "Applies once posts or comments are in."
  }, FEED_FORMS.map(form => /*#__PURE__*/React.createElement(Chip, {
    key: form.value,
    label: form.label,
    selected: (value.forms || []).includes(form.value),
    onToggle: () => toggle("forms", form.value),
    disabled: !postsish
  }))), topics.length > 0 && /*#__PURE__*/React.createElement(FilterSection, {
    label: "One topic",
    hint: "Topics you hold and are for. A topic you hold against stays a record \u2014 it just never narrows a feed."
  }, topics.map(topic => /*#__PURE__*/React.createElement(Chip, {
    key: topic,
    label: topic,
    selected: value.topic === topic,
    onToggle: () => set({
      topic: value.topic === topic ? null : topic
    })
  })), /*#__PURE__*/React.createElement("div", {
    style: {
      flexBasis: "100%"
  ...
  }, "All your topics"))), /*#__PURE__*/React.createElement(OrderSection, {
    order: value.order,
    onOrder: order => set({
      order
    }),
    ...
    label: "Also show",
    hint: "Sensitive content stays veiled until you tap it. A removed post keeps its place \u2014 author, time, and where it sat in the thread \u2014 never the content."
  }, FEED_ALSO.map(entry => /*#__PURE__*/React.createElement(Chip, {
    key: entry.value,
    label: entry.label,
    selected: (value.also || []).includes(entry.value),
    onToggle: () => toggle("also", entry.value)
  }))), /*#__PURE__*/React.createElement("div", {
    style: {
      padding: "0 var(--space-6)"
    }
    ...
    size: "sm",
    selfStart: true,
    onClick: () => onChange && onChange(FEED_FILTER_DEFAULT)
  }, "Reset")));
  return (
    /*#__PURE__*/
    ...
    React.createElement(BottomSheet, _extends({
      open: open,
      onClose: onClose,
      ariaLabel: ariaLabel
    }, foot ? {
    ...
    }, /*#__PURE__*/React.createElement(HelpDot, {
      ariaLabel: "How the filter works",
      onOpen: onHelp
...
__ds_scope.FEED_FORMS = FEED_FORMS;
...
const HISTORY_DOOR_LABEL = "See how this opinion built";
function StanceRow({
  name,
  handle,
  src,
  ...
  const person = /*#__PURE__*/React.createElement("button", {
    type: "button",
    onClick: onOpen,
    className: "cg-state cg-focus",
    style: onOpenHistory ? {
  ...
  }, "@", handle)), !onOpenHistory && /*#__PURE__*/React.createElement(StanceValue, {
    pDirected: pDirected,
    pInterest: pInterest
  }));
  ...
  }, /*#__PURE__*/React.createElement(StanceValue, {
    pDirected: pDirected,
    pInterest: pInterest
  })));
}
__ds_scope.HISTORY_DOOR_LABEL = HISTORY_DOOR_LABEL;
__ds_scope.StanceRow = StanceRow;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/people/StanceRow.jsx", error: String((e && e.message) || e) }); }

// components/wallet/WashCard.jsx
try { (() => {
const { CgtMark } = __ds_scope;
...
function WashCard({
  ...
  }, /*#__PURE__*/React.createElement(CgtMark, {
    size: 150
  })), children);
}
__ds_scope.WashCard = WashCard;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/wallet/WashCard.jsx", error: String((e && e.message) || e) }); }

// components/states/ComingSoonCard.jsx
try { (() => {
const { WashCard } = __ds_scope;
...
function ComingSoonCard({
  ...
  return /*#__PURE__*/React.createElement(WashCard, {
    ghost: false
  }, /*#__PURE__*/React.createElement("h2", {
    style: {
      margin: 0,
  ...
  }, thing, " \u2014 coming soon"), /*#__PURE__*/React.createElement("p", {
    style: {
      margin: 0,
      fontSize: "var(--text-body-medium)",
      lineHeight: "var(--text-body-medium--line-height)",
...
__ds_scope.ComingSoonCard = ComingSoonCard;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/states/ComingSoonCard.jsx", error: String((e && e.message) || e) }); }
...
__ds_scope.EarnedChart = EarnedChart;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/wallet/EarnedChart.jsx", error: String((e && e.message) || e) }); }

// components/wallet/LedgerRow.jsx
try { (() => {
const { ContentRow, MoneyFigure } = __ds_scope;
...
function LedgerRow({
  ...
  return /*#__PURE__*/React.createElement(ContentRow, {
    variant: "ledger",
    title: words,
    second: context || when ? /*#__PURE__*/React.createElement(React.Fragment, null, context, context && when ? " · " : "", when) : undefined,
    trailing: /*#__PURE__*/React.createElement(MoneyFigure, {
      amount: amount,
      signed: signed
    }),
    pending: pending,
...
__ds_scope.LedgerRow = LedgerRow;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/wallet/LedgerRow.jsx", error: String((e && e.message) || e) }); }

// components/wallet/PayoutAddress.jsx
try { (() => {
const { InlineAction, Icon } = __ds_scope;
...
function PayoutAddressRow({
  ...
  }, "Payouts land at"), /*#__PURE__*/React.createElement("code", {
    style: {
      flex: 1,
      minWidth: 0,
      fontFamily: "var(--font-mono)",
...
function PayoutAddress({
  ...
  }, label), onCopy && /*#__PURE__*/React.createElement("button", {
    type: "button",
  ...
  }, address), caption && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-label-small)",
      lineHeight: "var(--text-label-small--line-height)",
      letterSpacing: "var(--text-label-small--letter-spacing)",
...
__ds_scope.PayoutAddressRow = PayoutAddressRow;
__ds_scope.PayoutAddress = PayoutAddress;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/wallet/PayoutAddress.jsx", error: String((e && e.message) || e) }); }

// components/wallet/WalletBalance.jsx
try { (() => {
const { HelpDot, MoneyFigure, WashCard } = __ds_scope;
...
function WalletBalance({
  ...
  return /*#__PURE__*/React.createElement(WashCard, null, /*#__PURE__*/React.createElement("div", {
    style: {
      display: "flex",
      alignItems: "flex-start",
      justifyContent: "space-between",
  ...
  }, "Your balance"), /*#__PURE__*/React.createElement(HelpDot, {
    ariaLabel: "What is CGT?",
    onOpen: onHelp
  })), /*#__PURE__*/React.createElement("span", {
    style: {
      position: "relative",
  ...
  }, /*#__PURE__*/React.createElement(MoneyFigure, {
    amount: amount,
    unit: true
  })), (approx || delta) && amount !== 0 && /*#__PURE__*/React.createElement("div", {
    style: {
      position: "relative",
      display: "flex",
      alignItems: "center",
  ...
  }, approx && /*#__PURE__*/React.createElement("span", {
    style: {
      fontSize: "var(--text-label-small)",
      lineHeight: "var(--text-label-small--line-height)",
      letterSpacing: "var(--text-label-small--letter-spacing)",
  ...
  }, "\u2248 ", approx, " L-BTC right now"), delta && /*#__PURE__*/React.createElement("span", {
    style: {
      display: "inline-flex",
      alignItems: "center",
      minHeight: "24px",
...
__ds_scope.WalletBalance = WalletBalance;
})(); } catch (e) { __ds_ns.__errors.push({ path: "components/wallet/WalletBalance.jsx", error: String((e && e.message) || e) }); }

__ds_ns.ActsCard = __ds_scope.ActsCard;
...
__ds_ns.PickPrompt = __ds_scope.PickPrompt;

__ds_ns.PickTray = __ds_scope.PickTray;

__ds_ns.PickedRow = __ds_scope.PickedRow;

__ds_ns.DescribeCounter = __ds_scope.DescribeCounter;

__ds_ns.PickedSheet = __ds_scope.PickedSheet;

__ds_ns.RefusedFile = __ds_scope.RefusedFile;

__ds_ns.SealFooter = __ds_scope.SealFooter;

__ds_ns.StagedReference = __ds_scope.StagedReference;

__ds_ns.TagsSheet = __ds_scope.TagsSheet;

__ds_ns.TopicRemovable = __ds_scope.TopicRemovable;

__ds_ns.UploadStatusLine = __ds_scope.UploadStatusLine;

__ds_ns.UploadErrorLine = __ds_scope.UploadErrorLine;

__ds_ns.WizardFooter = __ds_scope.WizardFooter;
...
__ds_ns.TaggedRow = __ds_scope.TaggedRow;

__ds_ns.TopicsLine = __ds_scope.TopicsLine;

__ds_ns.BottomSheet = __ds_scope.BottomSheet;

__ds_ns.SheetItem = __ds_scope.SheetItem;

__ds_ns.SheetTitle = __ds_scope.SheetTitle;

__ds_ns.BUTTON_CLASS = __ds_scope.BUTTON_CLASS;

__ds_ns.InlineAction = __ds_scope.InlineAction;
...
__ds_ns.ContentRow = __ds_scope.ContentRow;

__ds_ns.FactRow = __ds_scope.FactRow;

__ds_ns.HelpDot = __ds_scope.HelpDot;

__ds_ns.DialogSurface = __ds_scope.DialogSurface;

__ds_ns.JoinPrompt = __ds_scope.JoinPrompt;

__ds_ns.CgtMark = __ds_scope.CgtMark;

__ds_ns.MoneyFigure = __ds_scope.MoneyFigure;

__ds_ns.QuietNote = __ds_scope.QuietNote;

__ds_ns.QuotedRow = __ds_scope.QuotedRow;
...
__ds_ns.ATTRIBUTION_TIERS = __ds_scope.ATTRIBUTION_TIERS;

__ds_ns.PROVENANCE_TIERS = __ds_scope.PROVENANCE_TIERS;

__ds_ns.PUBLIC_DOMAIN = __ds_scope.PUBLIC_DOMAIN;
...
__ds_ns.EditedMarker = __ds_scope.EditedMarker;

__ds_ns.SensitiveScope = __ds_scope.SensitiveScope;

__ds_ns.SensitiveVeil = __ds_scope.SensitiveVeil;

__ds_ns.RedactedContent = __ds_scope.RedactedContent;

__ds_ns.TransportError = __ds_scope.TransportError;

__ds_ns.SigningPending = __ds_scope.SigningPending;
...
__ds_ns.PinnedClip = __ds_scope.PinnedClip;

__ds_ns.ReelCaption = __ds_scope.ReelCaption;

__ds_ns.ReelRailItem = __ds_scope.ReelRailItem;

__ds_ns.ReelRail = __ds_scope.ReelRail;
...
__ds_ns.BorrowedViewBand = __ds_scope.BorrowedViewBand;

__ds_ns.ALL_SLOTS = __ds_scope.ALL_SLOTS;
...
__ds_ns.FEED_FORMS = __ds_scope.FEED_FORMS;

__ds_ns.FEED_ORDER = __ds_scope.FEED_ORDER;
...
__ds_ns.NODE_GLYPHS = __ds_scope.NODE_GLYPHS;

__ds_ns.Icon = __ds_scope.Icon;

__ds_ns.FILTER_ORDER = __ds_scope.FILTER_ORDER;

__ds_ns.FilterSection = __ds_scope.FilterSection;

__ds_ns.OrderSection = __ds_scope.OrderSection;
...
__ds_ns.ActorChip = __ds_scope.ActorChip;

__ds_ns.ProfileHeader = __ds_scope.ProfileHeader;

__ds_ns.HISTORY_DOOR_LABEL = __ds_scope.HISTORY_DOOR_LABEL;

__ds_ns.StanceRow = __ds_scope.StanceRow;
...
__ds_ns.STANCE_AXES = __ds_scope.STANCE_AXES;

__ds_ns.AXIS_GUTTER_X_PX = __ds_scope.AXIS_GUTTER_X_PX;

__ds_ns.AXIS_GUTTER_Y_PX = __ds_scope.AXIS_GUTTER_Y_PX;

__ds_ns.FIELD_CORNER_RADIUS_PX = __ds_scope.FIELD_CORNER_RADIUS_PX;

__ds_ns.KNOB_DIAMETER_PX = __ds_scope.KNOB_DIAMETER_PX;

__ds_ns.KNOB_TRAVEL_INSET_PX = __ds_scope.KNOB_TRAVEL_INSET_PX;

__ds_ns.StancePad = __ds_scope.StancePad;

__ds_ns.DIMENSION_MIN = __ds_scope.DIMENSION_MIN;

__ds_ns.DIMENSION_MAX = __ds_scope.DIMENSION_MAX;

__ds_ns.ORIGIN = __ds_scope.ORIGIN;

__ds_ns.STANCE_RANGES = __ds_scope.STANCE_RANGES;

__ds_ns.TAG_RELEVANCE_FLOOR = __ds_scope.TAG_RELEVANCE_FLOOR;

__ds_ns.TAG_RANGES = __ds_scope.TAG_RANGES;

__ds_ns.TAP_DEFAULT = __ds_scope.TAP_DEFAULT;

__ds_ns.DIRECTED_LABEL = __ds_scope.DIRECTED_LABEL;

__ds_ns.INTEREST_LABEL = __ds_scope.INTEREST_LABEL;

__ds_ns.DIRECTED_POLES = __ds_scope.DIRECTED_POLES;

__ds_ns.INTEREST_POLES = __ds_scope.INTEREST_POLES;

__ds_ns.STANCE_AXIS_NAMES = __ds_scope.STANCE_AXIS_NAMES;

__ds_ns.PICK_LABEL = __ds_scope.PICK_LABEL;

__ds_ns.HISTORY_DOOR_TAIL = __ds_scope.HISTORY_DOOR_TAIL;

__ds_ns.SEVERED_LABEL = __ds_scope.SEVERED_LABEL;

__ds_ns.NO_STANDING_LABEL = __ds_scope.NO_STANDING_LABEL;

__ds_ns.STANCE_SEVERANCE_WORDS = __ds_scope.STANCE_SEVERANCE_WORDS;

__ds_ns.ZERO_BUNDLE_EMOJI = __ds_scope.ZERO_BUNDLE_EMOJI;

__ds_ns.RESTING_FACE_EMOJI = __ds_scope.RESTING_FACE_EMOJI;

__ds_ns.SR_ONLY = __ds_scope.SR_ONLY;

__ds_ns.STANCE_ANCHORS = __ds_scope.STANCE_ANCHORS;

__ds_ns.VALENCE_SIX = __ds_scope.VALENCE_SIX;

__ds_ns.TAG_ANCHORS = __ds_scope.TAG_ANCHORS;

__ds_ns.StanceValue = __ds_scope.StanceValue;
...
__ds_ns.ComingSoonCard = __ds_scope.ComingSoonCard;

__ds_ns.EmptyState = __ds_scope.EmptyState;

__ds_ns.LoadingState = __ds_scope.LoadingState;

__ds_ns.EarnedChart = __ds_scope.EarnedChart;

__ds_ns.LedgerRow = __ds_scope.LedgerRow;

__ds_ns.PayoutAddressRow = __ds_scope.PayoutAddressRow;

__ds_ns.PayoutAddress = __ds_scope.PayoutAddress;

__ds_ns.WalletBalance = __ds_scope.WalletBalance;

__ds_ns.WashCard = __ds_scope.WashCard;
