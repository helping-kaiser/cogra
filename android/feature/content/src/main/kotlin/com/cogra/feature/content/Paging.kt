 ...
 * a held page against a newer one: it appends what is new, keeps the
 * copy it already showed, and waits for a refetch to carry the new
 * state (api-spec.md "Pending entries come first, in their own cursor
 * namespace" and "A page is a snapshot, not a live view").
 */
