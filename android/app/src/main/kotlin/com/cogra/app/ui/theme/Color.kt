...
internal object LightTokens {
    ...
    val error = Color(0xFFA5004A)
    val onError = Color(0xFFFFFFFF)
    val errorContainer = Color(0xFFFFD9DF)
    val onErrorContainer = Color(0xFF8F003F)
...
internal object DarkTokens {
    ...
    val error = Color(0xFFFF6B95)
    val onError = Color(0xFF66002B)
    val errorContainer = Color(0xFF8F003F)
